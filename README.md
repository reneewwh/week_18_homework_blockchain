...
5. As part of the “Add Block” button functionality, update `new_block` so that `Block` consists of an attribute named `record`, which is set equal to a `Record` that contains the `sender`, `receiver`, and `amount` v![Alt text](<Screenshot 2024-01-09 030108.png>)alues. The updated `Block` should also include the attributes for `creator_id` and `prev_hash`.
...
![Input_area](<./Images/Screenshot 2024-01-09 030108.png>)
...
![dropdown](<./Images/Screenshot 2024-01-09 030131.png>)
...
![validations](<./Images/Screenshot 2024-01-09 030201.png>)
